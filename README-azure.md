...
Configure your credentials the same way as [Azure Blob Storage](https://github.com/sushshring/goofys/blob/master/README-azure.md#azure-blob-storage) above, and then:
